RSpec.describe "iterating in ruby" do
  ...
  it "can `inject` a value - and probably blow your mind" do
    ...
    # --------------------------------------------------------------------------
    # Enumerable#inject iterates over an Enumerable, accepting an initial `sum`
    # value as an argument.
    #
    # With each iteration, the return value is passed back into inject and the
    # new `sum` value becomes the result of the previous iteration.
    # 
  end
