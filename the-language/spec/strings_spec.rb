...
END
  ...
  it "should support #succ" do
    str = "abc"

    expect( str.succ ).to eq "abd"
  end

  it 'should support squeeze' do
    str = "hello   world"

    expect( str.squeeze ).to eq "helo world"
  end

  it 'should support #pratition' do
    str = "abcde"

    expect( str.partition("c") ).to eq ["ab", "c", "de"]
  end

  it 'should support #tr' do
    str = "hello"

    expect( str.tr("ho", "jy") ).to eq "jelly"
  end
end
