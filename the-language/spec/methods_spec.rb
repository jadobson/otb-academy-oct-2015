...
RSpec.describe "methods in ruby" do
  ...
  context "methods on objects" do
    ...
    it "can call a protected method if the reciever is of the same class (or sub class)" do
      expect( an_object.calls_the_protected_method).to eq(:the_protected_value)
    end
  end
end
